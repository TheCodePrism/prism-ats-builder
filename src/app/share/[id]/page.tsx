      ...
      <div className="max-w-[900px] w-full">
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center text-primary-foreground font-black italic text-xs">RF</div>
            <h1 className="text-sm font-bold uppercase tracking-widest text-slate-500">Shared via ResumeForge AI</h1>
          </div>
